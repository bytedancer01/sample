...
/* loaded from: combined.jar:classes3.jar:tv/danmaku/ijk/media/player/IMediaPlayer.class */
public interface IMediaPlayer {
    ...
    /* loaded from: combined.jar:classes3.jar:tv/danmaku/ijk/media/player/IMediaPlayer$OnBufferingUpdateListener.class */
    public interface OnBufferingUpdateListener {
        void onBufferingUpdate(IMediaPlayer iMediaPlayer, int i10);
    }

    /* loaded from: combined.jar:classes3.jar:tv/danmaku/ijk/media/player/IMediaPlayer$OnCompletionListener.class */
    public interface OnCompletionListener {
        void onCompletion(IMediaPlayer iMediaPlayer);
    }

    /* loaded from: combined.jar:classes3.jar:tv/danmaku/ijk/media/player/IMediaPlayer$OnErrorListener.class */
    public interface OnErrorListener {
        boolean onError(IMediaPlayer iMediaPlayer, int i10, int i11);
    }

    /* loaded from: combined.jar:classes3.jar:tv/danmaku/ijk/media/player/IMediaPlayer$OnInfoListener.class */
    public interface OnInfoListener {
        boolean onInfo(IMediaPlayer iMediaPlayer, int i10, int i11);
    }

    /* loaded from: combined.jar:classes3.jar:tv/danmaku/ijk/media/player/IMediaPlayer$OnPreparedListener.class */
    public interface OnPreparedListener {
        void onPrepared(IMediaPlayer iMediaPlayer);
    }

    /* loaded from: combined.jar:classes3.jar:tv/danmaku/ijk/media/player/IMediaPlayer$OnSeekCompleteListener.class */
    public interface OnSeekCompleteListener {
        void onSeekComplete(IMediaPlayer iMediaPlayer);
    }

    /* loaded from: combined.jar:classes3.jar:tv/danmaku/ijk/media/player/IMediaPlayer$OnTimedTextListener.class */
    public interface OnTimedTextListener {
        void onTimedText(IMediaPlayer iMediaPlayer, IjkTimedText ijkTimedText);
    }

    /* loaded from: combined.jar:classes3.jar:tv/danmaku/ijk/media/player/IMediaPlayer$OnVideoSizeChangedListener.class */
