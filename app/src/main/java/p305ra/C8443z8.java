...
/* JADX WARN: Classes with same name are omitted:
  classes2.jar:ra/z8.class
 */
/* renamed from: ra.z8 */
/* loaded from: combined.jar:classes2.jar:ra/z8.class */
public final class C8443z8 extends AbstractC8084b9 {
    public C8443z8(Unsafe unsafe) {
        super(unsafe);
    }
