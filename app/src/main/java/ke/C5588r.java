...
/* JADX WARN: Classes with same name are omitted:
  classes2.jar:ke/r.class
 */
/* renamed from: ke.r */
/* loaded from: combined.jar:classes2.jar:ke/r.class */
public final class C5588r {

    /* renamed from: a */
    public static final Object f31667a;

    /* renamed from: b */
    public static final Object[][] f31668b;

    /* renamed from: c */
    public static final Object[][] f31669c;

    /* renamed from: d */
    public static final Object[][] f31670d;

    /* renamed from: e */
    public static final Object[][] f31671e;

    /* JADX WARN: Type inference failed for: r0v167, types: [java.lang.Object[], java.lang.Object[][]] */
    /* JADX WARN: Type inference failed for: r0v189, types: [java.lang.Object[], java.lang.Object[][]] */
    ...
    public static String m27630a(String str) {
        ...
        for (Object[] objArr : f31668b) {
            if (objArr[0].equals(substring)) {
                Object obj = objArr[1];
                return obj == f31667a ? m27632c(2, ((Integer) objArr[2]).intValue(), str) : m27631b(2, ((Integer) obj).intValue(), str);
            }
        }
        if (str.length() < 3) {
            throw C8695j.m37209a();
        ...
        for (Object[] objArr2 : f31669c) {
            if (objArr2[0].equals(substring2)) {
                Object obj2 = objArr2[1];
                return obj2 == f31667a ? m27632c(3, ((Integer) objArr2[2]).intValue(), str) : m27631b(3, ((Integer) obj2).intValue(), str);
            }
        }
        for (Object[] objArr3 : f31670d) {
            if (objArr3[0].equals(substring2)) {
                Object obj3 = objArr3[1];
                return obj3 == f31667a ? m27632c(4, ((Integer) objArr3[2]).intValue(), str) : m27631b(4, ((Integer) obj3).intValue(), str);
            }
        }
        if (str.length() < 4) {
            throw C8695j.m37209a();
        ...
        for (Object[] objArr4 : f31671e) {
            if (objArr4[0].equals(substring3)) {
                Object obj4 = objArr4[1];
                return obj4 == f31667a ? m27632c(4, ((Integer) objArr4[2]).intValue(), str) : m27631b(4, ((Integer) obj4).intValue(), str);
            }
        }
        throw C8695j.m37209a();
    }
    ...
    /* renamed from: b */
    public static String m27631b(int i10, int i11, String str) {
        if (str.length() < i10) {
            throw C8695j.m37209a();
        }
        ...
        String m27630a = m27630a(substring3);
        if (m27630a == null) {
            return str2;
        }
        return str2 + m27630a;
    ...
    /* renamed from: c */
    public static String m27632c(int i10, int i11, String str) {
        String substring = str.substring(0, i10);
