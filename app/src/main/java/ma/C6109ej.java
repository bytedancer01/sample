...
/* JADX WARN: Classes with same name are omitted:
  classes2.jar:ma/ej.class
 */
/* renamed from: ma.ej */
/* loaded from: combined.jar:classes2.jar:ma/ej.class */
public final class C6109ej extends AbstractC6172hj {
    public C6109ej(Unsafe unsafe) {
        super(unsafe);
    }
