...
/* loaded from: combined.jar:classes3.jar:org/joda/time/field/OffsetDateTimeField.class */
public class OffsetDateTimeField extends DecoratedDateTimeField {
    ...
    public OffsetDateTimeField(DateTimeField dateTimeField, int i10) {
        this(dateTimeField, dateTimeField == null ? null : dateTimeField.getType(), i10, NTLMEngineImpl.FLAG_REQUEST_56BIT_ENCRYPTION, Integer.MAX_VALUE);
    }

    public OffsetDateTimeField(DateTimeField dateTimeField, DateTimeFieldType dateTimeFieldType, int i10) {
        this(dateTimeField, dateTimeFieldType, i10, NTLMEngineImpl.FLAG_REQUEST_56BIT_ENCRYPTION, Integer.MAX_VALUE);
    }
