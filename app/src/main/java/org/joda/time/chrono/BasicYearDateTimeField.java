...
/* loaded from: combined.jar:classes3.jar:org/joda/time/chrono/BasicYearDateTimeField.class */
class BasicYearDateTimeField extends ImpreciseDateTimeField {
    ...
    public long roundCeiling(long j10) {
        int i10 = get(j10);
        long j11 = j10;
        if (j10 != this.iChronology.getYearMillis(i10)) {
            j11 = this.iChronology.getYearMillis(i10 + 1);
        }
        return j11;
    }
