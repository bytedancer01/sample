...
/* loaded from: combined.jar:classes3.jar:org/joda/time/LocalDateTime.class */
public final class LocalDateTime extends BaseLocal implements Serializable {
    ...
    /* loaded from: combined.jar:classes3.jar:org/joda/time/LocalDateTime$Property.class */
    ...
    private Date correctDstTransition(Date date, TimeZone timeZone) {
        ...
        LocalDateTime fromCalendarFields = fromCalendarFields(calendar2);
        if (fromCalendarFields.isBefore(this)) {
            LocalDateTime localDateTime3 = fromCalendarFields;
            while (true) {
                ...
                localDateTime3 = fromCalendarFields(calendar2);
            }
            for (localDateTime2 = localDateTime; !localDateTime2.isBefore(this); localDateTime2 = fromCalendarFields(calendar2)) {
            ...
            if (fromCalendarFields.equals(this)) {
                ...
                calendar = calendar2;
                if (fromCalendarFields(calendar3).equals(this)) {
                    calendar = calendar3;
                }
            }
        }
