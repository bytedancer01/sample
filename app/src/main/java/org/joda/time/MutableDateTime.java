...
/* loaded from: combined.jar:classes3.jar:org/joda/time/MutableDateTime.class */
public class MutableDateTime extends BaseDateTime implements ReadWritableDateTime, Cloneable {
    ...
    /* loaded from: combined.jar:classes3.jar:org/joda/time/MutableDateTime$Property.class */
    ...
    public void setDate(ReadableInstant readableInstant) {
        ...
        if (readableInstant instanceof ReadableDateTime) {
            ...
            j10 = instantMillis;
            if (zone != null) {
                j10 = zone.getMillisKeepLocal(getZone(), instantMillis);
            }
        }
        setDate(j10);
    }
    ...
    public void setTime(ReadableInstant readableInstant) {
        ...
        long j10 = instantMillis;
        if (zone != null) {
            j10 = zone.getMillisKeepLocal(DateTimeZone.UTC, instantMillis);
        }
        setTime(j10);
    }
