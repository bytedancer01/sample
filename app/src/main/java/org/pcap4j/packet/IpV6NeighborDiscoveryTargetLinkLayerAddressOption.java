...
/* loaded from: combined.jar:classes3.jar:org/pcap4j/packet/IpV6NeighborDiscoveryTargetLinkLayerAddressOption.class */
public final class IpV6NeighborDiscoveryTargetLinkLayerAddressOption implements IcmpV6CommonPacket.IpV6NeighborDiscoveryOption {
    ...
    /* loaded from: combined.jar:classes3.jar:org/pcap4j/packet/IpV6NeighborDiscoveryTargetLinkLayerAddressOption$Builder.class */
    public static final class Builder implements LengthBuilder<IpV6NeighborDiscoveryTargetLinkLayerAddressOption> {
        ...
        public LengthBuilder<IpV6NeighborDiscoveryTargetLinkLayerAddressOption> correctLengthAtBuild2(boolean z10) {
    ...
    private IpV6NeighborDiscoveryTargetLinkLayerAddressOption(byte[] bArr, int i10, int i11) {
        this.type = IpV6NeighborDiscoveryOptionType.TARGET_LINK_LAYER_ADDRESS;
        if (i11 < 8) {
    ...
    public static IpV6NeighborDiscoveryTargetLinkLayerAddressOption newInstance(byte[] bArr, int i10, int i11) {
        ByteArrays.validateBounds(bArr, i10, i11);
        return new IpV6NeighborDiscoveryTargetLinkLayerAddressOption(bArr, i10, i11);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.length != ipV6NeighborDiscoveryTargetLinkLayerAddressOption.length || !Arrays.equals(this.linkLayerAddress, ipV6NeighborDiscoveryTargetLinkLayerAddressOption.linkLayerAddress)) {
            z10 = false;
        }
        return z10;
    }
