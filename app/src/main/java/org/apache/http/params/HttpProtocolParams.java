...
@Deprecated
/* loaded from: combined.jar:classes3.jar:org/apache/http/params/HttpProtocolParams.class */
public final class HttpProtocolParams implements CoreProtocolPNames {
    ...
    public static void setUseExpectContinue(HttpParams httpParams, boolean z10) {
        Args.notNull(httpParams, "HTTP parameters");
        httpParams.setBooleanParameter(CoreProtocolPNames.USE_EXPECT_CONTINUE, z10);
    }
