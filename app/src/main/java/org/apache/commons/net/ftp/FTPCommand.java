...
/* JADX WARN: Classes with same name are omitted:
  classes2.jar:org/apache/commons/net/ftp/FTPCommand.class
 */
@Deprecated
/* loaded from: combined.jar:classes2.jar:org/apache/commons/net/ftp/FTPCommand.class */
public final class FTPCommand {
    ...
    public static void checkArray() {
        ...
        throw new RuntimeException("Incorrect _commands array. Should have length 40 found " + strArr.length);
    }
