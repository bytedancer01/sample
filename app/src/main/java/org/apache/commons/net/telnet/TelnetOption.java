...
/* JADX WARN: Classes with same name are omitted:
  classes2.jar:org/apache/commons/net/telnet/TelnetOption.class
 */
/* loaded from: combined.jar:classes2.jar:org/apache/commons/net/telnet/TelnetOption.class */
public class TelnetOption {
    ...
    public static final String getOption(int i10) {
        String[] strArr = __optionString;
        return strArr[i10].length() == 0 ? "UNASSIGNED" : strArr[i10];
    }

    public static final boolean isValidOption(int i10) {
        return i10 <= 255;
    }
}
