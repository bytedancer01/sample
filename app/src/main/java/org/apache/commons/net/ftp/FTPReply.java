...
/* JADX WARN: Classes with same name are omitted:
  classes2.jar:org/apache/commons/net/ftp/FTPReply.class
 */
/* loaded from: combined.jar:classes2.jar:org/apache/commons/net/ftp/FTPReply.class */
public final class FTPReply {
    ...
    public static boolean isPositivePreliminary(int i10) {
        return i10 >= 100 && i10 < 200;
    }

    public static boolean isProtectedReplyCode(int i10) {
