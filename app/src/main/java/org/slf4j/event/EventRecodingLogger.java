...
/* loaded from: combined.jar:classes3.jar:org/slf4j/event/EventRecodingLogger.class */
public class EventRecodingLogger implements Logger {
    ...
    private void recordEvent(Level level, String str, Object[] objArr, Throwable th2) {
        recordEvent(level, null, str, objArr, th2);
    }
    ...
    public void debug(String str, Throwable th2) {
        recordEvent(Level.DEBUG, str, null, th2);
    }
    ...
    public void debug(Marker marker, String str, Throwable th2) {
        recordEvent(Level.DEBUG, marker, str, null, th2);
    }
    ...
    public void error(String str, Throwable th2) {
        recordEvent(Level.ERROR, str, null, th2);
    }
    ...
    public void error(Marker marker, String str, Throwable th2) {
        recordEvent(Level.ERROR, marker, str, null, th2);
    }
    ...
    public void info(String str, Throwable th2) {
        recordEvent(Level.INFO, str, null, th2);
    }
    ...
    public void info(Marker marker, String str, Throwable th2) {
        recordEvent(Level.INFO, marker, str, null, th2);
    }
    ...
    public void trace(String str, Throwable th2) {
        recordEvent(Level.TRACE, str, null, th2);
    }
    ...
    public void trace(Marker marker, String str, Throwable th2) {
        recordEvent(Level.TRACE, marker, str, null, th2);
    }
    ...
    public void warn(String str, Throwable th2) {
        recordEvent(Level.WARN, str, null, th2);
    }
    ...
    public void warn(Marker marker, String str, Throwable th2) {
        recordEvent(Level.WARN, marker, str, null, th2);
    }
