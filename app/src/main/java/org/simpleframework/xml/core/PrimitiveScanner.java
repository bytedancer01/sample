...
/* loaded from: combined.jar:classes3.jar:org/simpleframework/xml/core/PrimitiveScanner.class */
class PrimitiveScanner implements Scanner {
    private final Detail detail;
    private final Section section = new EmptySection(this);

    /* loaded from: combined.jar:classes3.jar:org/simpleframework/xml/core/PrimitiveScanner$EmptySection.class */
