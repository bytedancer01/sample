...
/* loaded from: combined.jar:classes3.jar:org/simpleframework/xml/core/FieldScanner.class */
class FieldScanner extends ContactList {
    private final ContactMap done = new ContactMap();
    private final AnnotationFactory factory;
    private final Support support;

    /* loaded from: combined.jar:classes3.jar:org/simpleframework/xml/core/FieldScanner$FieldKey.class */
